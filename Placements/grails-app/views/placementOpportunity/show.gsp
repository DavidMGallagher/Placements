			...
			<ol class="property-list placementOpportunity">
				...
				<li class="fieldcontain">
					<span id="applications-label" class="property-label"><g:message code="placementOpportunity.applications.label" default="Applications" /></span>
						...
						<span class="property-value" aria-labelledby="applications-label"><g:link controller="student" action="show" id="${a.id}">${a?.name?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="status-label" class="property-label"><g:message code="placementOpportunity.status.label" default="Status" /></span>
						...
						<span class="property-value" aria-labelledby="status-label"><g:link controller="status" action="show" id="${placementOpportunityInstance?.status?.id}">${placementOpportunityInstance?.status?.code?.encodeAsHTML()}</g:link></span>
