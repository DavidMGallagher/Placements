...
class BootStrap {
    ...
    def placementOpportunity1 = new PlacementOpportunity(companyName:'ABC Design and Development', jobTitle:'Designer', status:status3).save();
    
    def placementOpportunity2 = new PlacementOpportunity(companyName:'Lloyds Telecommunication', jobTitle:'Database Administrator', status:status3).save();
    
    def placementOpportunity3 = new PlacementOpportunity(companyName:'Williams Development', jobTitle:'Programmer', status:status3).save();
	...
	def application2 = new Application(student:student2, jobTitle:placementOpportunity1, status:status3, dateCreated:new Date(), lastUpdated:new Date()).save();
    
    def application3 = new Application(student:student3, jobTitle:placementOpportunity1, status:status3, dateCreated: new Date(), lastUpdated:new Date()).save();
    
    def application4 = new Application(student:student4, jobTitle:placementOpportunity1, status:status3, dateCreated:new Date(), lastUpdated:new Date()).save();
    
    def application5 = new Application(student:student5, jobTitle:placementOpportunity1, status:status3, dateCreated:new Date(), lastUpdated:new Date()).save();
